...
const uint8_t SA_TYPE_ID_REGISTER = 0x00;
const uint8_t SA_TYPE_ID_AIR_CONDITIONER = 0x01;
const uint8_t SA_TYPE_ID_REFRIGERATOR = 0x02;
const uint8_t SA_TYPE_ID_WASHING_MACHINE = 0x03;
const uint8_t SA_TYPE_ID_DEHUMIDIFIER = 0x04;
const uint8_t SA_TYPE_ID_TV_SET = 0x05;
const uint8_t SA_TYPE_ID_DRYER = 0x06;
const uint8_t SA_TYPE_ID_HEAT_PUMP_WATER_HEATER = 0x07;
const uint8_t SA_TYPE_ID_AIR_PURIFIER = 0x08;
const uint8_t SA_TYPE_ID_ELECTRONIC_POT = 0x09;
const uint8_t SA_TYPE_ID_DRINKING_MACHINE = 0x0A;
const uint8_t SA_TYPE_ID_INDUCTION_COOKER = 0x0B;
const uint8_t SA_TYPE_ID_DISH_DRYER = 0x0C;
const uint8_t SA_TYPE_ID_MICROWAVE_OVEN = 0x0D;
const uint8_t SA_TYPE_ID_TOTAL_HEAT_EXCHANGER = 0x0E;
const uint8_t SA_TYPE_ID_ELECTRIC_FAN = 0x0F;
const uint8_t SA_TYPE_ID_GAS_WATER_HEATER = 0x10;
const uint8_t SA_TYPE_ID_LAMPS = 0x11;
const uint8_t SA_TYPE_ID_SMART_METER_GATEWAY = 0xE0;
const uint8_t SA_TYPE_ID_UNIVERSAL_DEVICE = 0xF0;
