...
class AirConditionerSelect : public select::Select, public TaiXiaListener, public Component {
 public:
  ...
  void set_swing_horizontal_angle_select(select::Select *select) { this->swing_horizontal_angle_select_ = select; }
 ...
 protected:
  ...
  select::Select *swing_horizontal_angle_select_{nullptr};
